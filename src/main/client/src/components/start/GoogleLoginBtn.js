...
function GoogleLoginBtn() {
  return (
    <a href={'http://ec2-3-34-172-246.ap-northeast-2.compute.amazonaws.com:8080/oauth2/authorization/google?redirect_uri=https://namkibok.shop/oauth2/redirect'} role={'button'}>
      <GoogleSigninBtn
